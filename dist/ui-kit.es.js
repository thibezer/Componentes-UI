...
class U extends HTMLElement {
  constructor() {
    ...
    n(this, "handleClick", (e) => {
      ...
      if (this.dispatchEvent(new CustomEvent("ui-click", { detail: { originalEvent: e }, bubbles: !0, composed: !0 })), this.hasAttribute("tipo-submit") || this.getAttribute("type") === "submit") {
    ...
    `, this.button = e.querySelector("button"), this.spinnerContainer = e.querySelector(".ui-botao-primario__spinner-container");
  }
...
class B {
  ...
  add(i, e, t, o) {
    if (!i) return;
    const a = t;
    i.addEventListener(e, a, o), this.entries.push({ target: i, type: e, listener: a, options: o });
  }
  /**
   * Remove todos os ouvintes de eventos atualmente registrados e esvazia a coleção.
   */
  cleanup() {
    this.entries.forEach(({ target: i, type: e, listener: t, options: o }) => {
...
class F extends HTMLElement {
  constructor() {
    ...
    n(this, "posicionarConteudo", () => {
      ...
      this.content.style.top = `${e.bottom + 2}px`, this.content.style.left = `${e.left}px`, this.content.style.minWidth = `${Math.max(e.width, 120)}px`;
    });
  ...
  connectedCallback() {
    this.listeners.cleanup(), this.listeners.add(this.button, "click", this.toggleLista), this.listeners.add(this.button, "keydown", this.handleKeyDown), this.listeners.add(this.content, "keydown", this.handleListKeyDown), this.listeners.add(this.backdropElement, "click", this.fechar), this.listeners.add(this.sheetCloseButton, "click", (e) => {
      e.stopPropagation(), this.fechar();
    }), this.listeners.add(document, "click", this.handleClickFora), this.carregarItensFilhos(), this.syncState(), this.observer = new MutationObserver(() => this.carregarItensFilhos()), this.observer.observe(this, { childList: !0, subtree: !0 });
  }
  carregarItensFilhos() {
    const e = Array.from(this.querySelectorAll("option, ui-opcao, [value]"));
    e.length > 0 && (this._itens = e.map((t, o) => {
      var a;
      return {
        id: t.getAttribute("value") || String(o + 1),
        label: ((a = t.textContent) == null ? void 0 : a.trim()) || t.getAttribute("value") || `Opção ${o + 1}`
      };
  ...
  attributeChangedCallback(e, t, o) {
    e === "aberta" && this.button.setAttribute("aria-expanded", String(o !== null)), (e === "texto-padrao" || e === "placeholder" || e === "label" || e === "rotulo") && this.syncLabel(), e === "value" && o !== this._value && (this.value = o || ""), e === "disabled" && (this.button.disabled = o !== null), (e === "altura" || e === "height") && (o ? this.style.setProperty("--ui-campo-altura", isNaN(Number(o)) ? o : `${o}px`) : this.style.removeProperty("--ui-campo-altura"));
  }
  get value() {
    return this._value;
  }
  ...
  syncLabel() {
    ...
    const t = this._itens.find((o) => String(o.id) === String(this._value));
    if (t)
  ...
  renderItens() {
    this.listElement.innerHTML = "", this._itens.forEach((e) => {
      const t = document.createElement("li"), o = String(e.id) === String(this._value);
      t.className = `ui-lista-flutuante__item ${o ? "ui-lista-flutuante__item--selecionado" : ""}`, t.setAttribute("data-id", e.id), t.textContent = e.label, t.role = "option", t.tabIndex = -1, o && t.setAttribute("aria-selected", "true"), t.addEventListener("click", (a) => {
        a.stopPropagation(), this.selecionarItem(e);
...
class se extends HTMLElement {
  ...
  render() {
    const e = this.resolveTag(), t = this.getAttribute("variante") || "corpo", o = this.getAttribute("cor"), a = this.getAttribute("peso"), r = this.getAttribute("alinhamento"), s = this.hasAttribute("truncar");
    if (this.container.tagName.toLowerCase() !== e) {
      const d = document.createElement(e);
      d.appendChild(document.createElement("slot")), this.shadow.replaceChild(d, this.container), this.container = d;
    }
...
class Y extends HTMLElement {
  constructor() {
    ...
    `, this.labelElement = e.querySelector(".ui-campo-texto__label"), this.wrapperElement = e.querySelector(".ui-campo-texto__wrapper"), this.inputElement = e.querySelector(".ui-campo-texto__input"), this.helperElement = e.querySelector(".ui-campo-texto__helper"), this.rightIconContainer = e.querySelector(".ui-campo-texto__icone--direita"), this.leftSlotElement = e.querySelector('slot[name="icone-esquerda"]'), this._inputId = `ui-input-${Math.random().toString(36).substring(2, 9)}`, this.inputElement.id = this._inputId, this.labelElement.htmlFor = this._inputId;
  }
  static get observedAttributes() {
    return [
      "label",
  ...
  attributeChangedCallback(e, t, o) {
    ...
    e === "value" && o !== this.inputElement.value && !a && (this.inputElement.value = o || ""), this.syncState();
  }
  get value() {
  ...
  alternarVisibilidadeSenha() {
    ...
    const t = (o = this.shadowRoot) == null ? void 0 : o.querySelector('slot[name="icone-direita"]');
  ...
  syncState() {
    ...
    t && this.style.setProperty("--ui-campo-altura", isNaN(Number(t)) ? t : `${t}px`);
    const o = this.getAttribute("label"), a = this.hasAttribute("label-flutuante"), r = this.inputElement.value.trim() !== "", s = this._focado, l = (() => {
      try {
    ...
    o ? (this.labelElement.textContent = o, this.labelElement.style.display = "flex", a ? s || r || l ? this.labelElement.classList.add("ui-campo-texto__label--ativa") : this.labelElement.classList.remove("ui-campo-texto__label--ativa") : this.labelElement.classList.remove("ui-campo-texto__label--ativa")) : this.labelElement.style.display = "none";
    const d = this.getAttribute("placeholder") || "";
    a && !s && !r && !l ? this.inputElement.placeholder = "" : this.inputElement.placeholder = d;
    const h = this.getAttribute("tipo") || "text";
    this._senhaVisivel || (this.inputElement.type = h), this.internals.setFormValue(this.inputElement.value);
    const c = this.hasAttribute("disabled"), p = this.hasAttribute("readonly");
    this.inputElement.disabled = c, this.inputElement.readOnly = p, c ? this.wrapperElement.classList.add("ui-campo-texto__wrapper--disabled") : this.wrapperElement.classList.remove("ui-campo-texto__wrapper--disabled"), h === "password" || this.hasAttribute("alternar-senha") ? this.rightIconContainer.classList.add("ui-campo-texto__icone--clicavel") : this.rightIconContainer.classList.remove("ui-campo-texto__icone--clicavel");
    const x = this.hasAttribute("erro") || this.hasAttribute("mensagem-erro"), f = this.getAttribute("mensagem-erro"), m = this.getAttribute("helper-text");
    x ? this.wrapperElement.classList.add("ui-campo-texto__wrapper--erro") : this.wrapperElement.classList.remove("ui-campo-texto__wrapper--erro"), x && f ? (this.helperElement.textContent = `⚠️ ${f}`, this.helperElement.className = "ui-campo-texto__helper ui-campo-texto__helper--erro", this.helperElement.style.display = "block") : m ? (this.helperElement.textContent = m, this.helperElement.className = "ui-campo-texto__helper", this.helperElement.style.display = "block") : this.helperElement.style.display = "none";
  }
  formResetCallback() {
    this.inputElement.value = "", this.removeAttribute("value"), this.syncState();
  }
}
n(Y, "formAssociated", !0);
customElements.get("ui-campo-texto") || customElements.define("ui-campo-texto", Y);
const le = ':host{display:inline-flex;align-items:center;justify-content:center;vertical-align:middle;line-height:1;color:inherit;flex-shrink:0;width:var(--ui-tamanho-icone, 20px);height:var(--ui-tamanho-icone, 20px);box-sizing:border-box}.ui-icone{display:inline-flex;align-items:center;justify-content:center;width:100%;height:100%;color:inherit;font-size:var(--ui-tamanho-icone, 20px)}::slotted(svg),.ui-icone svg{width:100%!important;height:100%!important;display:block}:host([cor="primaria"]),:host([color="primaria"]){color:var(--ui-cor-primaria, #00E08A)}:host([cor="secundaria"]),:host([color="secundaria"]){color:var(--ui-cor-texto-secundario, #888899)}:host([cor="erro"]),:host([color="erro"]){color:var(--ui-cor-texto-erro, #ff5555)}:host([cor="sucesso"]),:host([color="sucesso"]){color:var(--ui-cor-texto-sucesso, #00E08A)}:host([cor="alerta"]),:host([color="alerta"]){color:var(--ui-cor-texto-alerta, #ffb86c)}', D = {
...
class ce extends HTMLElement {
  constructor() {
    ...
    `, this.iconContainer = e.querySelector(".ui-icone");
  }
  static get observedAttributes() {
...
class Z extends HTMLElement {
  ...
  syncState() {
    const e = this.marcado, t = this.indeterminado, o = this.disabled, a = this.getAttribute("label"), r = this.getAttribute("posicao-label") || "direita";
...
const he = ':host{display:inline-flex;align-items:center;box-sizing:border-box;font-family:var(--ui-fonte-base, "Inter", sans-serif);vertical-align:middle}.ui-radio{display:inline-flex;align-items:center;gap:8px;cursor:pointer;-webkit-user-select:none;user-select:none;line-height:1;outline:none}.ui-radio--disabled{opacity:.5;cursor:not-allowed!important;pointer-events:none}.ui-radio__circle{display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;min-width:16px;min-height:16px;background-color:var(--ui-cor-fundo-elevado, #1a1a1e);border:1px solid var(--ui-cor-borda, rgba(255, 255, 255, .16));border-radius:50%;box-sizing:border-box;transition:background-color .15s ease,border-color .15s ease,box-shadow .15s ease;flex-shrink:0}.ui-radio:focus-visible .ui-radio__circle,.ui-radio--foco .ui-radio__circle{border-color:var(--ui-cor-primaria, #00E08A);box-shadow:0 0 0 2px #00e08a40}.ui-radio--checked .ui-radio__circle{border-color:var(--ui-cor-primaria, #00E08A)}.ui-radio__dot{width:8px;height:8px;border-radius:50%;background-color:var(--ui-cor-primaria, #00E08A);transition:transform .15s cubic-bezier(.4,0,.2,1),opacity .15s ease;transform:scale(0);opacity:0}.ui-radio--checked .ui-radio__dot{transform:scale(1);opacity:1}.ui-radio__label{font-size:clamp(11px,.8rem,14px);color:var(--ui-cor-texto, #e1e1e6);line-height:1}.ui-radio--label-esquerda{flex-direction:row-reverse}', L = class L extends HTMLElement {
  constructor() {
    ...
    n(this, "handleKeyDown", (e) => {
      if (e.key === " " || e.key === "Enter")
        ...
        e.preventDefault();
        const t = this.name;
        if (!t || !L._registry.has(t)) return;
        const o = Array.from(L._registry.get(t));
        if (o.length <= 1) return;
        const a = o.indexOf(this);
        let r = a;
        if (e.key === "ArrowDown" || e.key === "ArrowRight" ? r = (a + 1) % o.length : (e.key === "ArrowUp" || e.key === "ArrowLeft") && (r = (a - 1 + o.length) % o.length), r !== a) {
          const s = o[r];
  ...
  register() {
    const e = this.name;
    e && (L._registry.has(e) || L._registry.set(e, /* @__PURE__ */ new Set()), L._registry.get(e).add(this));
  }
  unregister() {
    const e = this.name;
    e && L._registry.has(e) && L._registry.get(e).delete(this);
  }
  attributeChangedCallback(e, t, o) {
    this.syncState();
  }
  ...
  selecionar() {
    ...
    const e = this.name;
    e && L._registry.has(e) && L._registry.get(e).forEach((o) => {
      o !== this && (o.removeAttribute("marcado"), o.removeAttribute("checked"), o.syncState());
  ...
  syncState() {
    const e = this.marcado, t = this.disabled, o = this.getAttribute("label"), a = this.getAttribute("posicao-label") || "direita";
...
class R extends HTMLElement {
  ...
  syncState() {
    const e = this.ativo, t = this.disabled, o = this.getAttribute("tamanho") || this.getAttribute("size") || "md", a = this.getAttribute("label"), r = this.getAttribute("posicao-label") || "direita";
...
class V extends HTMLElement {
  ...
  set removivel(e) {
    e ? this.setAttribute("removivel", "") : (this.removeAttribute("removivel"), this.removeAttribute("removable")), this.syncState();
  }
  syncState() {
    const e = this.getAttribute("variante") || this.getAttribute("variant") || "neutro", t = this.getAttribute("estilo") || "suave", o = this.getAttribute("label"), a = this.removivel;
    this.badgeElement.className = "ui-badge", this.badgeElement.classList.add(`ui-badge--${e}`), this.badgeElement.classList.add(`ui-badge--${t}`), o ? (this.labelElement.textContent = o, this.labelElement.style.display = "inline") : this.labelElement.style.display = "none", a ? this.closeElement.style.display = "inline-flex" : this.closeElement.style.display = "none";
  }
}
class fe extends V {
}
...
class xe extends HTMLElement {
  ...
  extrairIniciais(e) {
    ...
    const o = t[0][0], a = t[t.length - 1][0];
    return (o + a).toUpperCase();
  }
  syncState() {
    const e = this.getAttribute("src"), t = this.getAttribute("nome") || this.getAttribute("name") || "", o = this.getAttribute("tamanho") || this.getAttribute("size") || "md", a = this.getAttribute("formato") || "circulo", r = this.getAttribute("status");
    this.avatarElement.className = "ui-avatar", ["xs", "sm", "md", "lg", "xl"].includes(o) ? this.avatarElement.classList.add(`ui-avatar--${o}`) : isNaN(parseInt(o, 10)) || this.avatarElement.style.setProperty("--ui-tamanho-avatar", `${parseInt(o, 10)}px`), a === "quadrado" && this.avatarElement.classList.add("ui-avatar--quadrado");
    const s = this.avatarElement.querySelector(".ui-avatar__content");
    if (s)
      if (s.textContent = "", e) {
        const l = document.createElement("img");
        l.className = "ui-avatar__img", l.src = e, l.alt = t || "Avatar", l.onerror = () => {
          this.renderFallback(s, t);
        }, s.appendChild(l);
      } else
        this.renderFallback(s, t);
...
customElements.get("ui-avatar") || customElements.define("ui-avatar", xe);
...
const _e = ':host{display:block;box-sizing:border-box;font-family:var(--ui-fonte-base, "Inter", sans-serif)}.ui-modal__backdrop{display:none;position:fixed;top:0;left:0;width:100vw;height:100vh;background-color:#000000b3;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px);z-index:9998;opacity:0;pointer-events:none;transition:opacity .25s ease}:host([aberto]) .ui-modal__backdrop,:host([open]) .ui-modal__backdrop{display:block;opacity:1;pointer-events:auto}.ui-modal__dialog{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) scale(.95);max-width:560px;width:90%;max-height:85vh;background-color:var(--ui-cor-fundo-card, #18181c);border:1px solid var(--ui-cor-borda, rgba(255, 255, 255, .16));border-radius:var(--ui-raio-borda, 12px);box-shadow:0 12px 36px #0009;z-index:9999;display:flex;flex-direction:column;opacity:0;visibility:hidden;pointer-events:none;overflow:hidden;transition:transform .25s cubic-bezier(.4,0,.2,1),opacity .25s ease,visibility .25s ease;box-sizing:border-box;color:var(--ui-cor-texto, #e1e1e6)}:host([aberto]) .ui-modal__dialog,:host([open]) .ui-modal__dialog{opacity:1;visibility:visible;pointer-events:auto;transform:translate(-50%,-50%) scale(1)}.ui-modal__handle{display:none;width:36px;height:4px;border-radius:2px;background-color:#ffffff40;margin:6px auto 12px;flex-shrink:0}.ui-modal__header{padding:16px 20px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,.08);gap:12px}.ui-modal__titulo{font-size:1.1rem;font-weight:600;margin:0;color:var(--ui-cor-texto, #e1e1e6)}.ui-modal__close{background:transparent;border:none;color:var(--ui-cor-texto-secundario, #888899);font-size:16px;cursor:pointer;padding:4px 8px;border-radius:4px;line-height:1;transition:color .15s ease,background-color .15s ease}.ui-modal__close:hover{color:#fff;background-color:#ffffff1a}.ui-modal__body{padding:20px;overflow-y:auto;flex:1;box-sizing:border-box}.ui-modal__footer{padding:14px 20px;display:flex;align-items:center;justify-content:flex-end;gap:12px;border-top:1px solid rgba(255,255,255,.08);background-color:#00000026}@media (max-width: 640px){.ui-modal__dialog{top:auto!important;bottom:0!important;left:0!important;transform:translateY(100%)!important;width:100vw!important;max-width:100vw!important;border-radius:16px 16px 0 0!important;max-height:80vh!important;border-bottom:none!important;box-shadow:0 -8px 32px #000000b3!important}:host([aberto]) .ui-modal__dialog,:host([open]) .ui-modal__dialog{transform:translateY(0)!important}.ui-modal__handle{display:block!important}}:host([bottom-sheet]) .ui-modal__dialog{top:auto!important;bottom:0!important;left:0!important;transform:translateY(100%)!important;width:100vw!important;max-width:100vw!important;border-radius:16px 16px 0 0!important;max-height:80vh!important;border-bottom:none!important;box-shadow:0 -8px 32px #000000b3!important}:host([bottom-sheet][aberto]) .ui-modal__dialog,:host([bottom-sheet][open]) .ui-modal__dialog{transform:translateY(0)!important}:host([bottom-sheet]) .ui-modal__handle{display:block!important}', z = class z extends HTMLElement {
    ...
    n(this, "handleKeyDown", (e) => {
      ...
      if (this.aberto && this._isTopMostModal()) {
        if (e.key === "Escape")
          ...
          e.shiftKey ? (s === a || !this.contains(s) && !((t = this.shadowRoot) != null && t.contains(s))) && (e.preventDefault(), r.focus()) : (s === r || !this.contains(s) && !((o = this.shadowRoot) != null && o.contains(s))) && (e.preventDefault(), a.focus());
        }
      }
    });
    const e = this.attachShadow({ mode: "open" });
  ...
  syncState() {
    var a;
    const e = this.aberto, t = this.getAttribute("titulo") || this.getAttribute("title") || "", o = (a = this.shadowRoot) == null ? void 0 : a.querySelector(".ui-modal__footer");
    if (this.dialogElement.setAttribute("aria-hidden", String(!e)), t ? (this.tituloElement.textContent = t, this.tituloElement.style.display = "block") : this.tituloElement.style.display = "none", o) {
      const r = this.querySelector('[slot="rodape"], [slot="footer"]');
      o.style.display = r ? "flex" : "none";
    }
    e ? this.hasAttribute("data-scroll-locked") || (this.setAttribute("data-scroll-locked", "true"), z._openCount++, z._openCount === 1 && (document.body.style.overflow = "hidden")) : this.hasAttribute("data-scroll-locked") && (this.removeAttribute("data-scroll-locked"), z._openCount = Math.max(0, z._openCount - 1), z._openCount === 0 && (document.body.style.overflow = ""));
  }
  _atualizarFocables() {
    ...
    t = t.filter((r) => window.getComputedStyle(r).display !== "none");
    ...
    }), this._focables = [...t, ...a].filter((r) => !r.hasAttribute("disabled") && r.getAttribute("aria-hidden") !== "true");
  }
  _isTopMostModal() {
...
class K extends HTMLElement {
  constructor() {
    ...
    `, this.alertaElement = e.querySelector(".ui-alerta"), this.iconeElement = e.querySelector(".ui-alerta__icone"), this.tituloElement = e.querySelector(".ui-alerta__titulo"), this.mensagemElement = e.querySelector(".ui-alerta__mensagem"), this.closeElement = e.querySelector(".ui-alerta__close");
  }
  static get observedAttributes() {
    return [
      "tipo",
  ...
  syncState() {
    const e = this.getAttribute("tipo") || this.getAttribute("variante") || this.getAttribute("variant") || "info", t = this.getAttribute("titulo") || this.getAttribute("title"), o = this.getAttribute("mensagem"), a = this.hasAttribute("fechavel") || this.hasAttribute("dismissible");
    this.alertaElement.className = "ui-alerta", this.alertaElement.classList.add(`ui-alerta--${e}`), this.iconeElement.innerHTML = j[e] || j.info, t ? (this.tituloElement.textContent = t, this.tituloElement.style.display = "block") : this.tituloElement.style.display = "none", o && (this.mensagemElement.textContent = o), a ? this.closeElement.style.display = "block" : this.closeElement.style.display = "none";
  }
}
class q extends K {
  constructor() {
  ...
  connectedCallback() {
    ...
    !isNaN(t) && t > 0 && (this.timerId = setTimeout(() => {
      this.fechar();
    }, t));
  }
  disconnectedCallback() {
...
class X extends HTMLElement {
  constructor() {
    ...
    n(this, "posicionarBubble", () => {
      ...
      const e = this.getBoundingClientRect(), t = this.bubbleElement.getBoundingClientRect(), o = this.getAttribute("posicao") || this.getAttribute("position") || "topo";
      let a = "topo";
      ...
      let r = 0, s = 0;
      const l = 8;
      a === "topo" ? (r = e.top - t.height - l, s = e.left + e.width / 2 - t.width / 2) : a === "baixo" ? (r = e.bottom + l, s = e.left + e.width / 2 - t.width / 2) : a === "esquerda" ? (r = e.top + e.height / 2 - t.height / 2, s = e.left - t.width - l) : a === "direita" && (r = e.top + e.height / 2 - t.height / 2, s = e.right + l), s = Math.max(8, Math.min(s, window.innerWidth - t.width - 8)), r = Math.max(8, Math.min(r, window.innerHeight - t.height - 8)), this.bubbleElement.style.top = `${r}px`, this.bubbleElement.style.left = `${s}px`;
    });
    ...
    n(this, "handleClick", (e) => {
      const t = this.getAttribute("gatilho") || this.getAttribute("trigger") || "hover", o = window.matchMedia("(pointer: coarse)").matches;
      (t === "clique" || t === "click" || o) && (e.stopPropagation(), this.aberto = !this.aberto);
    });
  ...
  syncState() {
    var s;
    const e = this.aberto, t = this.getAttribute("posicao") || this.getAttribute("position") || "topo", o = this.getAttribute("texto") || this.getAttribute("text") || "", a = (s = this.shadowRoot) == null ? void 0 : s.querySelector(".ui-tooltip__texto");
    let r = "topo";
    if (["topo", "top"].includes(t) ? r = "topo" : ["baixo", "bottom"].includes(t) ? r = "baixo" : ["esquerda", "left"].includes(t) ? r = "esquerda" : ["direita", "right"].includes(t) && (r = "direita"), this.containerElement.className = `ui-tooltip ui-tooltip--${r}`, a && (o ? (a.textContent = o, a.style.display = "inline") : a.style.display = "none"), e) {
...
class Le extends HTMLElement {
  ...
  syncAttributes() {
    ...
    o && o !== this._src && (this._src = o, this.isConnected && this.carregarDoEndpoint(o));
  ...
  async carregarDoEndpoint(e) {
    const t = e || this._src;
    if (t) {
      this.carregando = !0, this.dispatchEvent(new CustomEvent("ui-fetch-start", { bubbles: !0, composed: !0, detail: { url: t } }));
      try {
        const o = await fetch(t);
        if (!o.ok)
          throw new Error(`HTTP ${o.status}: ${o.statusText}`);
        const a = await o.json(), r = Array.isArray(a) ? a : a.dados || a.items || a.data || a.rows || [];
        this.dados = r, this.carregando = !1, this.dispatchEvent(
        ...
        this.carregando = !1, console.error("[ui-tabela] Erro ao carregar dados remotos:", o), this.dispatchEvent(
          new CustomEvent("ui-fetch-erro", {
            bubbles: !0,
            composed: !0,
            detail: { url: t, erro: o.message || String(o) }
          })
        );
      }
    }
  ...
  filtrar(e) {
    ...
    const t = this._dadosOriginais.filter((o) => Object.values(o).some((a) => a == null ? !1 : String(a).toLowerCase().includes(this._ultimoFiltro)));
  ...
  cleanupEventListeners() {
    this._containerElement && this._scrollHandler && (this._containerElement.removeEventListener("scroll", this._scrollHandler), this._scrollHandler = null), this._activeResizeCleanup && (this._activeResizeCleanup(), this._activeResizeCleanup = null), this._headerListeners.cleanup();
  }
  addHeaderListener(e, t, o) {
    this._headerListeners.add(e, t, o);
  }
  ...
  aplicarOrdenacao() {
    ...
    this._dadosExibicao = [...this._dadosOriginais].sort((o, a) => {
      const r = o[e], s = a[e];
      return r === s ? 0 : r == null ? 1 * t : s == null ? -1 * t : typeof r == "number" && typeof s == "number" ? (r - s) * t : String(r).localeCompare(String(s), "pt-BR", { numeric: !0, sensitivity: "base" }) * t;
    });
  }
  // Redimensionamento de Colunas (Drag-to-resize)
  initColumnResize(e, t, o, a, r) {
    var x;
    e.stopPropagation(), e.preventDefault(), this._isResizing = !0, r.classList.add("ui-tabela__resizer--ativo");
    const s = e.pageX, l = a.offsetWidth, d = (x = this._colgroupElement) == null ? void 0 : x.children[o], h = (f) => {
      const m = f.pageX - s;
      let u = l + m;
      if (t.larguraMinima !== void 0) {
        const b = typeof t.larguraMinima == "number" ? t.larguraMinima : parseInt(t.larguraMinima, 10);
        isNaN(b) || (u = Math.max(b, u));
      } else
        u = Math.max(60, u);
      if (t.larguraMaxima !== void 0) {
        const b = typeof t.larguraMaxima == "number" ? t.larguraMaxima : parseInt(t.larguraMaxima, 10);
        isNaN(b) || (u = Math.min(b, u));
      }
      t.largura = `${u}px`, a.style.width = `${u}px`, d && (d.style.width = `${u}px`);
    }, c = () => {
      r.classList.remove("ui-tabela__resizer--ativo"), window.removeEventListener("mousemove", h), window.removeEventListener("mouseup", p), this._activeResizeCleanup = null, setTimeout(() => {
        this._isResizing = !1;
      }, 50);
    }, p = () => {
    ...
    this._activeResizeCleanup = c, window.addEventListener("mousemove", h), window.addEventListener("mouseup", p);
  }
  // Mini-Popover de Redimensionamento Exato
  showPromptPopover(e, t, o, a) {
    const r = document.createElement("dialog");
    r.className = "ui-tabela__prompt-dialog", r.style.position = "fixed", r.style.left = `${e.clientX}px`, r.style.top = `${e.clientY}px`;
    const s = document.createElement("div");
    s.className = "ui-tabela__prompt-title", s.textContent = `Largura para "${t.rotulo}" (px ou auto):`;
    const l = document.createElement("input");
    l.type = "text";
    const d = t.largura ? String(t.largura).replace("px", "") : "auto";
    l.value = d;
    const h = document.createElement("div");
    h.className = "ui-tabela__prompt-actions";
    const c = document.createElement("button");
    c.textContent = "Aplicar";
    const p = document.createElement("button");
    p.textContent = "Cancelar", h.appendChild(p), h.appendChild(c), r.appendChild(s), r.appendChild(l), r.appendChild(h), this.shadow.appendChild(r), r.showModal();
    const x = () => {
      var u, b;
      const m = l.value.trim().toLowerCase();
      if (m === "" || m === "auto")
        t.largura = void 0, a.style.width = "", (u = this._colgroupElement) != null && u.children[o] && (this._colgroupElement.children[o].style.width = "");
      else {
        const _ = parseInt(m, 10);
        !isNaN(_) && _ > 20 && (t.largura = `${_}px`, a.style.width = `${_}px`, (b = this._colgroupElement) != null && b.children[o] && (this._colgroupElement.children[o].style.width = `${_}px`));
      }
    ...
    c.addEventListener("click", x), p.addEventListener("click", () => {
      r.close(), r.remove();
    }), l.addEventListener("keydown", (f) => {
      f.key === "Enter" && x(), f.key === "Escape" && (r.close(), r.remove());
    }), l.focus(), l.select();
  }
  handleHeaderContextMenu(e, t, o, a) {
    e.preventDefault(), e.stopPropagation(), this.showPromptPopover(e, t, o, a);
  }
  formatWidth(e) {
  ...
  renderTotal() {
    ...
    this.cleanupEventListeners(), this.shadow.innerHTML = `<style>${Ce}</style>`;
    ...
    o.className = "ui-tabela__empty", o.style.display = "none";
    ...
    `, this._loadingElement = s, t.appendChild(this._loadingElement), this.shadow.appendChild(t), this.renderHeader(), this.renderBody(), this._virtualizar && this._containerElement && (this._ticking = !1, this._scrollHandler = () => {
  ...
  renderHeader() {
    ...
    this._colunas.forEach((t, o) => {
      ...
      const r = document.createElement("th"), s = this.getAlignmentClass(t.alinhamento);
      if (r.className = s, r.style.textAlign = this.getTextAlign(t.alinhamento), t.largura !== void 0 && (r.style.width = this.formatWidth(t.largura)), t.larguraMinima !== void 0 && (r.style.minWidth = this.formatWidth(t.larguraMinima)), t.larguraMaxima !== void 0) {
        const m = this.formatWidth(t.larguraMaxima);
        r.style.maxWidth = m, r.style.overflow = "hidden", r.style.textOverflow = "ellipsis", r.style.whiteSpace = "nowrap";
      }
      if (t.tooltip && (r.title = t.tooltip), t.ordenavel) {
        r.classList.add("ui-tabela__th--ordenavel");
        const m = () => this.handleHeaderClick(t);
        this.addHeaderListener(r, "click", m);
      }
      const l = (m) => this.handleHeaderContextMenu(m, t, o, r);
      this.addHeaderListener(r, "contextmenu", l);
      const d = document.createElement("div");
      d.className = "ui-tabela__header-content";
      const h = document.createElement("span");
      h.className = "ui-tabela__header-text", h.textContent = t.rotulo, d.appendChild(h);
      const c = document.createElement("span");
      if (c.className = "ui-tabela__sort-icon", t.ordenavel) {
        const m = this._colunaOrdenada === t.id && this._direcaoOrdenacao !== "original", u = m && this._direcaoOrdenacao === "desc", b = m ? "" : "ui-tabela__sort-arrow--inativo", _ = u ? "ui-tabela__sort-arrow--desc" : "";
        c.innerHTML = `
          <svg class="ui-tabela__sort-arrow ${b} ${_}" viewBox="0 0 24 24">
      ...
      const x = (m) => this.initColumnResize(m, t, o, r, p);
      this.addHeaderListener(p, "mousedown", x);
      const f = (m) => {
        m.stopPropagation(), t.largura = void 0, r.style.width = "", a.style.width = "", this.dispatchEvent(new CustomEvent("ui-column-resize", { bubbles: !0, composed: !0, detail: { idColuna: t.id, largura: "auto" } }));
      };
      this.addHeaderListener(p, "dblclick", f), r.appendChild(p), e.appendChild(r);
  ...
  renderBody() {
    ...
    const e = this._dadosExibicao.length, t = this.getRowHeight(), o = this._virtualizar && e > 30;
    let a = 0, r = e;
    if (o) {
      const l = this._containerElement.scrollTop, d = this._containerElement.clientHeight || 400, h = 5;
      a = Math.max(0, Math.floor(l / t) - h), r = Math.min(e, Math.ceil((l + d) / t) + h);
    }
    ...
    if (o && a > 0) {
      ...
      d.colSpan = this._colunas.length || 1, l.appendChild(d), s.appendChild(l);
    }
    for (let l = a; l < r; l++) {
      const d = this._dadosExibicao[l], h = document.createElement("tr");
      this._colunas.forEach((c) => {
        const p = document.createElement("td"), x = this.getAlignmentClass(c.alinhamento);
        if (p.className = x, p.style.textAlign = this.getTextAlign(c.alinhamento), c.larguraMaxima !== void 0) {
          const u = this.formatWidth(c.larguraMaxima);
          p.style.maxWidth = u, p.style.overflow = "hidden", p.style.textOverflow = "ellipsis", p.style.whiteSpace = "nowrap";
        }
        const f = document.createElement("div");
        f.className = "ui-tabela__cell-content", c.larguraMaxima !== void 0 && f.classList.add("ui-tabela__cell-truncate");
        const m = d[c.id];
        if (typeof c.render == "function") {
          const u = c.render(m, d, l);
          u instanceof Node ? f.appendChild(u) : f.textContent = String(u ?? "");
        } else if (m instanceof Node)
          f.appendChild(m);
        else {
          const u = m != null ? String(m) : "";
          f.textContent = u, c.larguraMaxima !== void 0 && !c.tooltip && (p.title = u);
        }
    ...
    if (o && r < e) {
      const l = document.createElement("tr");
      l.className = "ui-tabela__virtual-spacer", l.style.height = `${(e - r) * t}px`;
      const d = document.createElement("td");
      d.colSpan = this._colunas.length || 1, l.appendChild(d), s.appendChild(l);
    }
...
class ze extends HTMLElement {
  ...
  initMap() {
    ...
    const e = parseFloat(this.getAttribute("lat") || "-23.550520"), t = parseFloat(this.getAttribute("lng") || "-46.633308"), o = parseInt(this.getAttribute("zoom") || "13", 10);
    this.mapInstance = v.map(this.mapContainer).setView([e, t], o);
    const a = this.getAttribute("camadas");
    let r = ["osm"];
    a && (r = a.split(",").map((l) => l.trim().toLowerCase()).filter((l) => T[l]), r.length === 0 && (r = ["osm"]));
    const s = T[r[0]].layer();
    if (s.addTo(this.mapInstance), r.length > 1) {
      ...
      for (let d = 1; d < r.length; d++) {
        const h = r[d];
        l[T[h].nome] = T[h].layer();
      }
      v.control.layers(l, void 0, { position: "topright" }).addTo(this.mapInstance);
    }
    v.Icon.Default.imagePath = "https://unpkg.com/leaflet@1.9.4/dist/images/", setTimeout(() => {
...
customElements.get("ui-mapa") || customElements.define("ui-mapa", ze);
class Me extends HTMLElement {
  ...
  attributeChangedCallback(e, t, o) {
    if (t !== o && this.marker) {
      if (e === "lat" || e === "lng") {
        const a = parseFloat(this.getAttribute("lat") || "0"), r = parseFloat(this.getAttribute("lng") || "0");
        this.marker.setLatLng([a, r]);
      }
      e === "titulo" && (this.marker.unbindPopup(), o && this.marker.bindPopup(this.createPopupContent(o)));
    }
  }
  ...
  initMarker() {
    ...
    const o = parseFloat(this.getAttribute("lat") || "0"), a = parseFloat(this.getAttribute("lng") || "0"), r = this.getAttribute("titulo");
    this.marker = v.marker([o, a]), r && this.marker.bindPopup(this.createPopupContent(r)), this.marker.addTo(t);
  }
}
customElements.get("ui-mapa-marcador") || customElements.define("ui-mapa-marcador", Me);
class Ie extends HTMLElement {
  ...
  attributeChangedCallback(e, t, o) {
    t !== o && this.polyline && (e === "pontos" ? this.polyline.setLatLngs(this.getPontos()) : (e === "cor" || e === "espessura") && this.polyline.setStyle({
...
n(I, "instance");
let O = I;
const w = (g) => g == null ? "" : String(g).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;"), Ze = (g, i = 3) => g == null || isNaN(g) ? "—" : g.toLocaleString("pt-BR", {
...
class Te {
  constructor(i) {
    n(this, "map", null);
    n(this, "configManager", O.getInstance());
    n(this, "config", this.configManager.getConfig());
    n(this, "apiBaseUrl", "/api");
    n(this, "bancoPontosGroup", v.layerGroup());
    n(this, "pontosVizinhosGroup", v.layerGroup());
    n(this, "controller");
  ...
  init(i) {
    ...
    const e = typeof i == "string" ? document.getElementById(i) : i;
    return e ? (this.containerElement = e, this.map = v.map(e, {
      maxZoom: 24,
      scrollWheelZoom: !0,
    ...
    }).setView([-23.7661, -53.3204], 14), this.listenConfigBroadcast(), this.applyMapStyles(), v.control.scale({
      metric: !0,
      imperial: !1,
      position: "bottomleft"
  ...
  preCarregarTilesRegiao(i) {
    if (!this.map) return;
    const e = this.map.getZoom(), t = Math.max(Math.floor(e) - 2, 10), o = Math.min(Math.floor(e) + 3, 20), a = i.pad(0.5), r = ["mt0", "mt1", "mt2", "mt3"];
    let s = 0;
    const l = 300;
    for (let d = t; d <= o && s < l; d++) {
      const h = a.getNorthWest(), c = a.getSouthEast(), p = this.lonToTileX(h.lng, d), x = this.lonToTileX(c.lng, d), f = this.latToTileY(h.lat, d), m = this.latToTileY(c.lat, d);
      for (let u = p; u <= x && s < l; u++)
        for (let b = f; b <= m && s < l; b++) {
          const A = `https://${r[(u + b) % r.length]}.google.com/vt/lyrs=s,h&x=${u}&y=${b}&z=${d}`, E = new Image();
          E.src = A, s++;
        }
    }
  }
  ...
  async consultarSigef(i) {
    if (!this.map) return;
    const e = this.map.getSize(), t = this.map.getBounds(), o = t.getSouthWest(), a = t.getNorthEast(), r = `${o.lng},${o.lat},${a.lng},${a.lat}`, s = Math.round(this.map.layerPointToContainerPoint(i.layerPoint).x), l = Math.round(this.map.layerPointToContainerPoint(i.layerPoint).y), d = `https://acervofundiario.incra.gov.br/i3geo/ogc.php?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetFeatureInfo&FORMAT=image/png&TRANSPARENT=true&QUERY_LAYERS=certificada_sigef_particular_pr&LAYERS=certificada_sigef_particular_pr&INFO_FORMAT=application/json&X=${s}&Y=${l}&WIDTH=${e.x}&HEIGHT=${e.y}&SRS=EPSG:4326&BBOX=${r}`, h = this.map.getContainer();
    h.style.cursor = "wait";
    const c = v.popup({
      ...
      `).openOn(this.map);
    try {
      const x = typeof window < "u" && (window.location.origin.includes("localhost") || window.location.origin.includes("127.0.0.1") || window.location.origin.includes("[::1]")) ? `${this.apiBaseUrl}/proxy/sigef?url=${encodeURIComponent(d)}` : `${window.location.origin}/api.php?action=proxy_sigef&url=${encodeURIComponent(d)}`, f = await fetch(x);
      let m = null;
      if (f.ok) {
      ...
      if (m && m.features && m.features.length > 0) {
        const u = m.features[0], b = u.properties || {}, _ = String(u.id || b.parcela_codigo || b.co_parcela || b.id_parcela || ""), A = String(b.nome_area || b.nome_imovel || "Imóvel Sem Nome");
        if (_) {
          const E = encodeURIComponent(_), y = `https://sigef.incra.gov.br/geo/exportar/parcela/shp/${E}/`, C = `https://sigef.incra.gov.br/geo/parcela/detalhe/${E}/`, k = document.createElement("div");
          k.style.cssText = "font-family:sans-serif; color:rgba(255, 255, 255, 0.9); line-height:1.4; min-width:180px;", k.innerHTML = `
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px; padding-bottom:5px; border-bottom:1px solid rgba(255, 255, 255, 0.1);">
              ...
              <span style="font-size:10px; color:rgba(255, 255, 255, 0.5);">${w(b.situacao_informada || b.status || "Certificada")}</span>
            </div>
            <div style="font-weight:700; font-size:12px; margin-bottom:4px; color:#ffffff; word-break:break-word;">${w(A)}</div>
            <div style="font-size:11px; color:rgba(255, 255, 255, 0.7); margin-bottom:2px;">Cód: <span style="font-family:monospace;">${w(b.codigo_imovel || "N/A")}</span></div>
            <div style="display:flex; gap:12px; font-size:11px; color:rgba(255, 255, 255, 0.7); margin-bottom:6px;">
              <span>Mat: <strong style="color:#ffffff;">${w(b.registro_matricula || b.matricula || "N/A")}</strong></span>
              <span>${w(b.data_submissao || "")}</span>
            </div>
            <div style="display:flex; flex-direction:column; gap:5px; padding-top:6px; border-top:1px solid rgba(255, 255, 255, 0.1);">
              <a href="${y}" target="_blank" rel="noopener noreferrer" style="display:flex; align-items:center; justify-content:center; gap:5px; padding:5px 8px; background:rgba(16, 185, 129, 0.15); border:1px solid rgba(16, 185, 129, 0.3); color:#34d399; font-size:11px; font-weight:700; border-radius:5px; text-decoration:none; cursor:pointer;">
      ...
      console.warn("Erro ao consultar SIGEF:", p), c.setContent(`
...
class qe {
  constructor(i) {
    ...
    n(this, "handleMouseDown", (i) => {
      if (!(!this.map || !this.mapContainer)) {
        if (i.button === 1) {
          ...
          this.lastMiddleClickTime = e, this.isPanning = !0, this.lastMousePos = { x: i.clientX, y: i.clientY }, this.mapContainer.style.cursor = "grabbing";
          return;
        }
        if (i.button === 0) {
          if (this.ctx.mapaController && this.ctx.mapaController.modoCliqueSequencialAtivo)
            return;
          const e = this.mapContainer.getBoundingClientRect(), t = i.clientX - e.left, o = i.clientY - e.top;
          this.isSelecting = !0, this.selectStartPos = { x: t, y: o }, this.selectStartPoint = this.map.mouseEventToContainerPoint(i), this.selectionDiv && (this.selectionDiv.style.left = `${t}px`, this.selectionDiv.style.top = `${o}px`, this.selectionDiv.style.width = "0px", this.selectionDiv.style.height = "0px", this.selectionDiv.style.display = "block"), ["verticesPane", "perimetroPane", "overlayPane", "pane-vertices", "pane-perimetro", "pane-vizinhos"].forEach((r) => {
            var l;
            const s = (l = this.map) == null ? void 0 : l.getPane(r);
    ...
    n(this, "handleMouseMove", (i) => {
      if (!(!this.map || !this.mapContainer)) {
        if (this.isPanning) {
          const e = this.lastMousePos.x - i.clientX, t = this.lastMousePos.y - i.clientY;
          this.map.panBy([e, t], { animate: !1 }), this.lastMousePos = { x: i.clientX, y: i.clientY };
          return;
        }
        if (this.isSelecting && this.selectionDiv) {
          const e = this.mapContainer.getBoundingClientRect(), t = i.clientX - e.left, o = i.clientY - e.top, a = Math.abs(t - this.selectStartPos.x), r = Math.abs(o - this.selectStartPos.y), s = Math.min(t, this.selectStartPos.x), l = Math.min(o, this.selectStartPos.y);
          this.selectionDiv.style.left = `${s}px`, this.selectionDiv.style.top = `${l}px`, this.selectionDiv.style.width = `${a}px`, this.selectionDiv.style.height = `${r}px`, t >= this.selectStartPos.x ? (this.selectionDiv.style.background = "rgba(14, 116, 144, 0.22)", this.selectionDiv.style.border = "1.5px solid #06b6d4") : (this.selectionDiv.style.background = "rgba(16, 185, 129, 0.22)", this.selectionDiv.style.border = "1.5px dashed #10b981");
        }
      }
    });
    n(this, "handleMouseUp", (i) => {
      ...
      if (this.isPanning && (this.isPanning = !1, this.mapContainer && (this.mapContainer.style.cursor = "grab")), this.isSelecting) {
        ...
        const l = this.mapContainer.getBoundingClientRect(), d = i.clientX - l.left, h = i.clientY - l.top, c = this.map.mouseEventToContainerPoint(i), p = Math.abs(d - this.selectStartPos.x), x = Math.abs(h - this.selectStartPos.y);
        if (p < 4 && x < 4) {
          const y = i.target;
          y && ((e = y.classList) != null && e.contains("leaflet-container") || y.id === "mapa-triagem" || (t = y.closest) != null && t.call(y, ".leaflet-pane")) && ((o = y.closest) != null && o.call(y, ".custom-leaflet-marker") || (a = y.closest) != null && a.call(y, ".custom-div-icon") || this.limparSelecao());
          return;
        }
        ...
        }, m = ((r = this.ctx.mapaController) == null ? void 0 : r.getMarkers()) || [], u = ((s = this.ctx.mapaController) == null ? void 0 : s.getVizinhosMarkers()) || [], b = [], _ = [], A = !this.ctx.layerManager || this.ctx.layerManager.isLayerActiveAndSelectable("vertices"), E = !this.ctx.layerManager || this.ctx.layerManager.isLayerActiveAndSelectable("vizinhos");
        A && m.forEach((y) => {
          const C = y.pontoId;
          if (!C) return;
          const k = this.map.latLngToContainerPoint(y.getLatLng());
          k.x >= f.x1 && k.x <= f.x2 && k.y >= f.y1 && k.y <= f.y2 && b.push(C);
        }), E && u.forEach((y) => {
          const C = y.pontoId;
          if (!C) return;
          const k = this.map.latLngToContainerPoint(y.getLatLng());
          k.x >= f.x1 && k.x <= f.x2 && k.y >= f.y1 && k.y <= f.y2 && _.push(C);
        }), i.ctrlKey || i.metaKey ? (b.forEach((y) => {
          this.ctx.selectedPontoIds.includes(y) ? this.ctx.selectedPontoIds = this.ctx.selectedPontoIds.filter((C) => C !== y) : this.ctx.selectedPontoIds.push(y);
        }), _.forEach((y) => {
          this.ctx.selectedVizinhoPontoIds.includes(y) ? this.ctx.selectedVizinhoPontoIds = this.ctx.selectedVizinhoPontoIds.filter((C) => C !== y) : this.ctx.selectedVizinhoPontoIds.push(y);
        })) : (this.ctx.selectedPontoIds = b, this.ctx.selectedVizinhoPontoIds = _), this.ctx.selectedPontoIds.length > 0 && (this.ctx.lastSelectedPontoId = this.ctx.selectedPontoIds[this.ctx.selectedPontoIds.length - 1]), this.notificarSelecao();
      }
    });
    n(this, "handleKeyDown", (i) => {
      i.key === "Escape" && this.limparSelecao();
    });
    this.ctx = {
      selectedPontoIds: [],
  ...
  ativar(i, e) {
    if (this.ctx.mapaController = i, e && (this.ctx.containerHost = e), this.map = i.getMap(), !!this.map && (this.mapContainer = this.map.getContainer(), !!this.mapContainer)) {
  ...
  zoomExtents() {
    ...
    const i = this.ctx.pontosList.filter((e) => e.tipo_ponto !== "B" && e.tipo !== "B");
...
class S {
  static register(i, e) {
    this.renderers.set(i.toLowerCase(), e);
  }
  static get(i) {
...
class Be {
  render(i, e, t) {
    var l, d, h;
    const o = ((l = i.dados) == null ? void 0 : l.url) || "https://{s}.google.com/vt/lyrs=s,h&x={x}&y={y}&z={z}", a = ((d = i.dados) == null ? void 0 : d.subdomains) || ["mt0", "mt1", "mt2", "mt3"], r = ((h = i.dados) == null ? void 0 : h.attribution) || "Google Satélite";
    return v.tileLayer(o, {
      maxZoom: 24,
      maxNativeZoom: 20,
      subdomains: a,
      attribution: r,
  ...
  update(i, e, t) {
    e instanceof v.TileLayer && t.opacidade !== void 0 && e.setOpacity(t.opacidade);
  }
  destroy(i, e) {
...
class Ne {
  render(i, e, t) {
    var d, h, c, p;
    const o = ((d = i.dados) == null ? void 0 : d.url) || "https://acervofundiario.incra.gov.br/i3geo/ogc.php", a = ((h = i.dados) == null ? void 0 : h.layers) || "certificada_sigef_particular_pr", r = ((c = i.dados) == null ? void 0 : c.format) || "image/png", s = ((p = i.dados) == null ? void 0 : p.attribution) || "INCRA/SIGEF";
    return v.tileLayer.wms(o, {
      layers: a,
      format: r,
      transparent: !0,
      version: "1.1.1",
  ...
  update(i, e, t) {
    e instanceof v.TileLayer.WMS && t.opacidade !== void 0 && e.setOpacity(t.opacidade);
  }
  destroy(i, e) {
    e.hasLayer(i) && e.removeLayer(i);
  }
...
class $e {
  ...
  render(i, e, t) {
    const o = v.layerGroup(), a = `pane-${i.id}`;
    this.rebuildLines(i, o, e, t, a);
    const r = () => {
      if (i.estilo.scaleMode === "world") {
        const s = this.calculateWeight(i, e, t);
        o.eachLayer((l) => {
          l.setStyle && l.setStyle({ weight: s });
        });
      }
    };
    return e.on("zoomend", r), this.zoomListenerMap.set(o, r), o;
  }
  calculateWeight(i, e, t) {
    const o = i.estilo.espessuraLinha || t.config.perimetroWeight || 2, a = t.graphicScale.lineScaleMultiplier || 1;
    if (i.estilo.scaleMode === "world") {
      const r = i.estilo.dimensaoMetros || 0.3, s = e.getCenter(), l = e.getZoom(), d = 40075016686e-3 * Math.abs(Math.cos(s.lat * Math.PI / 180)) / Math.pow(2, l + 8), h = r / (d > 0 ? d : 1);
      return Math.max(1, Math.round(h * a));
    }
    return Math.max(1, Math.round(o * a));
  }
  rebuildLines(i, e, t, o, a) {
    var c, p;
    const r = ((c = i.dados) == null ? void 0 : c.segmentos) || o.segmentos || [], s = ((p = i.dados) == null ? void 0 : p.pontos) || o.pontos || [], l = this.calculateWeight(i, t, o), d = i.opacidade !== void 0 ? i.opacidade : 1, h = i.interativo && !i.bloqueada;
    if (r && r.length > 0)
      r.forEach((x) => {
        const f = s.find((u) => String(u.id) === String(x.ponto_inicio_id)), m = s.find((u) => String(u.id) === String(x.ponto_fim_id));
        if (f && m && f.lat && f.lon && m.lat && m.lon) {
          const u = x.tipo_limite_sigef || x.tipo_limite || "", b = x.metodo_posicionamento_sigef || x.metodo_posicionamento || "", _ = u === "LA1" ? "#10b981" : u === "LN1" ? "#3b82f6" : "#00f5a0", A = i.estilo.corPrimaria || _, E = v.polyline([[f.lat, f.lon], [m.lat, m.lon]], {
            color: A,
            weight: l,
            opacity: d,
            dashArray: u === "LN1" ? "6, 6" : i.estilo.dashArray,
            pane: a,
            interactive: h
          });
          h && E.bindPopup(`
              <div style="font-family:sans-serif; color:rgba(255, 255, 255, 0.9); line-height:1.3;">
                <div style="font-weight:700; font-size:12px; margin-bottom:3px; color:#ffffff;">${w(f.nome_vertice)} ↔ ${w(m.nome_vertice)}</div>
                <div style="font-size:11px; color:rgba(255, 255, 255, 0.65);">Limite: ${w(u || "N/A")} · ${w(b || "N/A")}</div>
              </div>
            `, {
      ...
      x.forEach((u) => {
        const b = u.matricula_id != null ? `mat_${u.matricula_id}` : u.planilha_origem || "default";
        f[b] || (f[b] = []), f[b].push(u);
      });
      const m = i.estilo.corPrimaria || "#10b981";
      Object.values(f).forEach((u) => {
        if (u.sort((E, y) => Number(E.ordem_caminhamento ?? 999999) - Number(y.ordem_caminhamento ?? 999999)), u.length < 2) return;
        for (let E = 0; E < u.length - 1; E++) {
          const y = u[E], C = u[E + 1];
          v.polyline([[y.lat, y.lon], [C.lat, C.lon]], {
            color: m,
            weight: l,
            opacity: d,
            pane: a,
        ...
        const b = u[u.length - 1], _ = u[0];
        v.polyline([[b.lat, b.lon], [_.lat, _.lon]], {
          color: m,
          weight: l,
          opacity: d,
          dashArray: "4, 4",
  ...
  update(i, e, t, o, a) {
    (t.opacidade !== void 0 || t.estilo !== void 0 || t.dados !== void 0) && (e.clearLayers(), this.rebuildLines(i, e, a, o, `pane-${i.id}`));
  }
  destroy(i, e) {
    const t = this.zoomListenerMap.get(i);
    t && (e.off("zoomend", t), this.zoomListenerMap.delete(i)), i.clearLayers(), e.hasLayer(i) && e.removeLayer(i);
  }
}
function $(g, i, e, t = "", o = "") {
  ...
  switch (g) {
    case "square":
      return `<div id="${o}" class="${e} ${t} rounded-sm shadow-md" style="width:${r}px; height:${r}px;"></div>`;
    case "circle-dot":
      return `
        <div id="${o}" class="relative flex items-center justify-center ${t}" style="${a}">
          <div class="${e} rounded-full shadow-md" style="width:${r}px; height:${r}px;"></div>
    ...
    case "triangle":
      return `
        <div id="${o}" class="${t}" style="width:0; height:0; border-left:${r / 2}px solid transparent; border-right:${r / 2}px solid transparent; border-bottom:${r}px solid currentColor;"></div>
      `;
    case "circle":
    default:
      return `<div id="${o}" class="${e} ${t} rounded-full shadow-md" style="width:${r}px; height:${r}px;"></div>`;
  }
}
class He {
  constructor() {
  ...
  render(i, e, t) {
    const o = v.layerGroup(), a = `pane-${i.id}`;
    this.rebuildPoints(i, o, e, t, a);
    const r = () => {
      i.estilo.scaleMode === "world" && o.eachLayer((s) => {
        if (s.setIcon && s.baseSize && s.shapeStyle && s.markerBg && s.pontoId) {
          const l = this.calculateSize(i, e, t, s.baseSize), d = t.config.enableAnimations ? "transition-all duration-150" : "", h = $(s.shapeStyle, l, s.markerBg, d, `map-marker-${i.id}-${s.pontoId}`), c = v.divIcon({
            html: h,
  ...
  calculateSize(i, e, t, o) {
    const a = t.graphicScale.markerScaleMultiplier || 1;
    if (i.estilo.scaleMode === "world") {
      const r = i.estilo.dimensaoMetros || 0.25, s = e.getCenter(), l = e.getZoom(), d = 40075016686e-3 * Math.abs(Math.cos(s.lat * Math.PI / 180)) / Math.pow(2, l + 8), h = r / (d > 0 ? d : 1);
      return Math.max(3, Math.round(h * a));
    }
    return Math.max(4, Math.round(o * a));
  }
  rebuildPoints(i, e, t, o, a) {
    var h;
    const r = ((h = i.dados) == null ? void 0 : h.pontos) || o.pontos || [], s = i.interativo && !i.bloqueada, l = i.id === "vizinhos", d = i.id === "homologados";
    r.forEach((c) => {
      const p = c.lat ?? c.latitude, x = c.lon ?? c.lng ?? c.longitude;
      if (p && x && p !== 0 && x !== 0) {
        const f = c.tipo_ponto === "B" || c.tipo === "B", m = c.tipo_ponto === "M" || c.tipo === "M";
        let u = i.estilo.estiloMarcador || "x", b = "bg-mint-vibrant", _ = i.estilo.tamanhoMarcador || 7;
        d ? (u = "circle", b = "bg-amber-500", _ = 8) : l ? (u = m ? "circle-dot" : "cross", b = "bg-[#a855f7]", _ = m ? 10 : 8) : m ? (b = "bg-indigo-500", u = "circle-dot", _ = 10) : f && (b = "bg-rose-500", u = "square", _ = 9);
        const A = this.calculateSize(i, t, o, _), E = o.config.enableAnimations ? "transition-all duration-150" : "", y = $(u, A, b, E, `map-marker-${i.id}-${c.id}`), C = v.divIcon({
          html: y,
          className: "custom-leaflet-marker flex items-center justify-center",
          iconSize: [A + 6, A + 6]
        }), k = v.marker([p, x], {
        ...
        if (k.pontoId = c.id, k.layerId = i.id, k.isVizinho = l, k.baseSize = _, k.shapeStyle = u, k.markerBg = b, s) {
          const P = d ? "Vértice Homologado SIGEF" : l ? "Confrontante (Importado)" : m ? "Base Homologada PPP" : f ? "Base de Campo (Translação)" : "Vértice de Perímetro";
          k.bindPopup(`
            <div style="font-family:sans-serif; color:rgba(255, 255, 255, 0.9); line-height:1.3;">
              <div style="font-weight:700; font-size:13px; margin-bottom:4px; color:#ffffff;">${w(c.nome_vertice || String(c.id))}</div>
              <div style="font-size:11px; color:rgba(255, 255, 255, 0.65);">${w(P)} · ${w(c.tipo_ponto || c.tipo || "Vértice")}</div>
              <div style="font-size:11px; color:rgba(255, 255, 255, 0.45); font-family:monospace; margin-top:4px;">Lat ${Number(p).toFixed(6)} &nbsp; Lon ${Number(x).toFixed(6)}</div>
            </div>
          `, {
            className: "compact-popup",
            maxWidth: 220
          }), k.on("click", () => {
            o.onMarkerClick && o.onMarkerClick(c.id, l);
          });
        }
        k.addTo(e);
      }
  ...
  update(i, e, t, o, a) {
    (t.opacidade !== void 0 || t.estilo !== void 0 || t.dados !== void 0 || t.interativo !== void 0 || t.bloqueada !== void 0) && (e.clearLayers(), this.rebuildPoints(i, e, a, o, `pane-${i.id}`));
  }
  destroy(i, e) {
    const t = this.zoomListenerMap.get(i);
    t && (e.off("zoomend", t), this.zoomListenerMap.delete(i)), i.clearLayers(), e.hasLayer(i) && e.removeLayer(i);
...
class Oe {
  render(i, e, t) {
    const o = v.layerGroup(), a = `pane-${i.id}`;
    return this.rebuildPolygons(i, o, t, a), o;
  }
  rebuildPolygons(i, e, t, o) {
    var h;
    const a = ((h = i.dados) == null ? void 0 : h.confrontantes) || t.confrontantes || [], r = i.interativo && !i.bloqueada, s = i.estilo.corPrimaria || "#a855f7", l = i.estilo.espessuraLinha || 1.5, d = i.opacidade !== void 0 ? i.opacidade : 0.8;
    a.forEach((c) => {
      if (!c || !c.poligono_wkt) return;
      const p = [...c.poligono_wkt.matchAll(/\(([^()]+)\)/g)];
      if (p.length === 0) return;
      const x = w(c.nome_propriedade || "Propriedade Vizinha"), f = w(c.nome || "Desconhecido");
      p.forEach((m) => {
        const u = m[1].split(",").map((_) => {
          const A = _.trim().split(/\s+/), E = parseFloat(A[0]), y = parseFloat(A[1]);
          return !isNaN(y) && !isNaN(E) ? [y, E] : null;
        }).filter((_) => _ !== null);
        ...
        const b = v.polygon(u, {
          ...
          weight: l,
          opacity: d,
          dashArray: i.estilo.dashArray || "4, 6",
          fillColor: s,
          fillOpacity: Math.min(0.2, d * 0.15),
          pane: o,
          interactive: r
        });
        r && b.bindPopup(`
            <div style="font-family:sans-serif; color:rgba(255, 255, 255, 0.9); line-height:1.3; min-width:180px;">
              ...
              <div style="font-size:11px; margin-bottom:2px;"><strong>Propriedade:</strong> ${x}</div>
              <div style="font-size:11px;"><strong>Proprietário:</strong> ${f}</div>
            </div>
          `, { className: "compact-popup", maxWidth: 220 }), b.addTo(e);
      });
    });
  }
  update(i, e, t, o) {
    (t.opacidade !== void 0 || t.estilo !== void 0 || t.dados !== void 0 || t.interativo !== void 0 || t.bloqueada !== void 0) && (e.clearLayers(), this.rebuildPolygons(i, e, o, `pane-${i.id}`));
  }
  destroy(i, e) {
    i.clearLayers(), e.hasLayer(i) && e.removeLayer(i);
  }
}
class Fe {
  constructor() {
  ...
  render(i, e, t) {
    const o = v.layerGroup(), a = `pane-${i.id}`, r = () => {
      if (o.clearLayers(), !i.visivel) return;
      if (e.getZoom() > 20) {
        const l = e.getBounds(), d = l.getSouth(), h = l.getNorth(), c = l.getWest(), p = l.getEast(), x = e.getCenter(), f = 8999e-9, m = Math.cos(x.lat * Math.PI / 180), u = f / (m > 0.1 ? m : 1), b = Math.floor((h - d) / f), _ = Math.floor((p - c) / u);
        if (b < 200 && _ < 200) {
          const A = Math.ceil(d / f) * f;
          for (let y = A; y <= h; y += f)
            v.polyline([[y, c], [y, p]], {
    ...
    return r(), e.on("zoomend moveend", r), this.moveListenerMap.set(o, r), o;
  }
  update(i, e) {
    i.visivel || e.clearLayers();
  }
  destroy(i, e) {
    const t = this.moveListenerMap.get(i);
    t && (e.off("zoomend moveend", t), this.moveListenerMap.delete(i)), i.clearLayers(), e.hasLayer(i) && e.removeLayer(i);
  }
}
S.register("tile", new Be());
S.register("wms", new Ne());
S.register("vetorial-linhas", new $e());
S.register("vetorial-pontos", new He());
S.register("vetorial-poligonos", new Oe());
S.register("grid", new Fe());
const Re = [
  {
    id: "satelite",
...
class Ve {
  constructor(i) {
    ...
    n(this, "context", null);
    n(this, "listeners", []);
    this.layers = (i || Re).map((e) => ({ ...e, estilo: { ...e.estilo } }));
  }
  attachMap(i, e) {
    this.map = i, this.context = e, this.ensurePanes(), this.renderAllLayers();
  }
  ensurePanes() {
    this.map && this.layers.forEach((i) => {
      const e = `pane-${i.id}`;
      let t = this.map.getPane(e);
      t || (t = this.map.createPane(e)), t && (t.style.zIndex = String(i.zIndex), t.style.pointerEvents = i.interativo && !i.bloqueada && i.visivel ? "auto" : "none");
    });
  }
  renderAllLayers() {
    !this.map || !this.context || (this.layers.forEach((i) => {
      if (this.layerInstances.has(i.id)) {
        const e = this.layerInstances.get(i.id), t = S.get(i.tipo);
        t && t.destroy(e, this.map), this.layerInstances.delete(i.id);
      }
      if (i.visivel) {
        const e = S.get(i.tipo);
        if (e) {
          const t = e.render(i, this.map, this.context);
          t && (t.addTo(this.map), this.layerInstances.set(i.id, t));
        }
      }
    }), this.notifyChange());
  }
  setLayerVisibility(i, e) {
    const t = this.layers.find((r) => r.id === i);
    if (!t || t.visivel === e || (t.visivel = e, !this.map || !this.context)) return;
    const o = `pane-${t.id}`, a = this.map.getPane(o);
    if (a && (a.style.display = e ? "" : "none", a.style.pointerEvents = t.visivel && t.interativo && !t.bloqueada ? "auto" : "none"), e) {
      if (!this.layerInstances.has(i)) {
        const r = S.get(t.tipo);
        if (r) {
          const s = r.render(t, this.map, this.context);
          s && (s.addTo(this.map), this.layerInstances.set(i, s));
        }
      }
    } else if (this.layerInstances.has(i)) {
      const r = this.layerInstances.get(i), s = S.get(t.tipo);
      s && s.destroy(r, this.map), this.layerInstances.delete(i);
    }
    this.notifyChange();
  }
  setLayerOpacity(i, e) {
    const t = this.layers.find((a) => a.id === i);
    if (!t) return;
    ...
    if (o && this.map && this.context) {
      ...
      a && a.update(t, o, { opacidade: t.opacidade }, this.context, this.map);
    }
    this.notifyChange();
  }
  setLayerZIndex(i, e) {
    const t = this.layers.find((o) => o.id === i);
    if (t) {
      if (t.zIndex = e, this.map) {
        const o = this.map.getPane(`pane-${i}`);
        o && (o.style.zIndex = String(e));
      }
      this.notifyChange();
    }
  }
  setLayerBlocked(i, e) {
    ...
    if (t) {
      if (t.bloqueada = e, this.map) {
        const o = this.map.getPane(`pane-${i}`);
        o && (o.style.pointerEvents = t.visivel && t.interativo && !e ? "auto" : "none");
      }
      this.notifyChange();
    }
  }
  setLayerScaleMode(i, e) {
    const t = this.layers.find((a) => a.id === i);
    if (!t) return;
    ...
    if (o && this.map && this.context) {
      const a = S.get(t.tipo);
      a && a.update(t, o, { estilo: t.estilo }, this.context, this.map);
    }
    this.notifyChange();
  }
  setGraphicScale(i) {
  ...
  isLayerActiveAndSelectable(i) {
    const e = this.layers.find((t) => t.id === i);
  ...
  importState(i) {
    !i || !Array.isArray(i) || (i.forEach((e) => {
      const t = this.layers.find((o) => o.id === e.id);
  ...
  onChange(i) {
    return this.listeners.push(i), () => {
      this.listeners = this.listeners.filter((e) => e !== i);
    };
  }
  notifyChange() {
  ...
  destroy() {
    this.map && (this.layerInstances.forEach((i, e) => {
      const t = this.layers.find((o) => o.id === e);
      if (t) {
        const o = S.get(t.tipo);
...
class De {
  constructor(i) {
    ...
    this.core = new Te(this), this.layerManager = new Ve(i), this.canvasInteracao = new qe({
      mapaController: this,
  ...
  init(i, e) {
    const t = this.core.init(i);
    return t && (this.layerManager.attachMap(t, this.context), this.canvasInteracao.ativar(this, e)), t;
  }
  invalidateSize() {
    var i;
    try {
      (i = this.core) == null || i.invalidateSize();
    } catch {
    }
  }
  setPontos(i) {
    this.context.pontos = i, this.canvasInteracao.ctx.pontosList = i, this.layerManager.updateContext({ pontos: i });
  }
  setSegmentos(i) {
    this.context.segmentos = i, this.layerManager.updateContext({ segmentos: i });
  }
  setBancoPontos(i) {
    this.context.bancoPontos = i, this.layerManager.updateContext({ bancoPontos: i });
  }
  setConfrontantes(i) {
    this.context.confrontantes = i, this.layerManager.updateContext({ confrontantes: i });
  }
  setGraphicScale(i) {
  ...
  fitBounds(i, e = [40, 40], t = !1) {
    if (!this.core.map) return;
    let a = [...i || this.context.pontos || []];
    t && this.context.confrontantes && this.context.confrontantes.forEach((s) => {
      s.pontos && a.push(...s.pontos);
    });
    const r = a.map((s) => {
      const l = s.lat ?? s.latitude ?? s.y ?? s.norte, d = s.lon ?? s.lng ?? s.longitude ?? s.x ?? s.este, h = typeof l == "string" ? parseFloat(l) : Number(l), c = typeof d == "string" ? parseFloat(d) : Number(d);
      return h !== void 0 && c !== void 0 && !isNaN(h) && !isNaN(c) && h !== 0 && c !== 0 ? v.latLng(h, c) : null;
    }).filter((s) => s !== null);
    if (r.length === 1)
      this.core.map.setView(r[0], 18);
    else if (r.length > 1) {
      const s = v.latLngBounds(r);
      this.core.map.fitBounds(s, { padding: e }), this.core.map.once("moveend", () => {
  ...
  getMarkers() {
    ...
    return this.core.map && this.core.map.eachLayer((e) => {
      e instanceof v.Marker && e.pontoId && i.push(e);
    }), i;
  }
  getVizinhosMarkers() {
...
class je extends HTMLElement {
  constructor() {
    ...
    n(this, "initTimeout");
    n(this, "uiListeners", new B());
    n(this, "layerItemListeners", new B());
    n(this, "_pontos", []);
    n(this, "_segmentos", []);
    n(this, "_bancoPontos", []);
    n(this, "_confrontantes", []);
    this.shadow = this.attachShadow({ mode: "open" }), this.controller = new De(), this.shadow.innerHTML = `
      <style>
        ${Q}
        ${Pe}
      </style>
  ...
  disconnectedCallback() {
    this.initTimeout && window.clearTimeout(this.initTimeout), this.uiListeners.cleanup(), this.layerItemListeners.cleanup(), this.controller.destroy();
  }
  attributeChangedCallback(e, t, o) {
    if (t !== o)
      if (e === "sat-opacity") {
      ...
      } else e === "scale-mode" && (o === "world" || o === "screen") && (this.setLayerScaleMode("perimetro", o), this.setLayerScaleMode("vertices", o));
  }
  initCAD() {
  ...
  setupUIEvents() {
    ...
    const e = this.shadow.getElementById("btn-toggle-layers"), t = this.shadow.getElementById("btn-close-layers"), o = this.shadow.getElementById("btn-zoom-extents"), a = this.shadow.getElementById("btn-clear-selection");
  ...
  renderLayersUI() {
    ...
    if (e.querySelectorAll(".layer-item").length === t.length) {
      t.forEach((a) => {
        const r = e.querySelector(`.layer-item[data-layer-id="${a.id}"]`);
        if (r) {
          const s = r.querySelector(".layer-chk-visibility");
          s && s.checked !== a.visivel && (s.checked = a.visivel);
          const l = r.querySelector(".layer-opacity-slider"), d = r.querySelector(".opacity-percent-label"), h = Math.round(a.opacidade * 100);
          l && parseInt(l.value, 10) !== h && (l.value = String(h)), d && (d.textContent = `${h}%`);
          const c = r.querySelector(".btn-lock-layer");
          c && (c.classList.toggle("active", !!a.bloqueada), c.title = a.bloqueada ? "Desbloquear Camada" : "Bloquear Camada");
          const p = r.querySelector(".btn-toggle-scale-mode");
    ...
    `, this.layerItemListeners.cleanup(), e.querySelectorAll(".layer-chk-visibility").forEach((a) => {
      this.layerItemListeners.add(a, "change", (r) => {
        ...
        s && this.setLayerVisibility(s, l);
      });
    }), e.querySelectorAll(".layer-opacity-slider").forEach((a) => {
      this.layerItemListeners.add(a, "input", (r) => {
        const s = r.target.getAttribute("data-layer-id"), l = parseInt(r.target.value, 10), d = l / 100, h = r.target.closest(".layer-item"), c = h == null ? void 0 : h.querySelector(".opacity-percent-label");
        c && (c.textContent = `${l}%`), s && this.setLayerOpacity(s, d);
      });
      ...
      this.layerItemListeners.add(a, "click", (r) => {
        ...
        if (s) {
          const l = this.controller.layerManager.getLayers().find((d) => d.id === s);
          l && this.controller.layerManager.setLayerBlocked(s, !l.bloqueada);
        }
      });
      ...
      this.layerItemListeners.add(a, "click", (r) => {
        ...
        if (s) {
          const l = this.controller.layerManager.getLayers().find((d) => d.id === s);
          if (l) {
            const d = l.estilo.scaleMode === "world" ? "screen" : "world";
            this.setLayerScaleMode(s, d);
          }
        }
      });
    });
  ...
  // --- Métodos Públicos ---
  fitBounds(e, t = [40, 40], o = !1) {
    this.controller.fitBounds(e, t, o);
  }
  zoomExtents() {
...
customElements.get("ui-canvas-cad") || customElements.define("ui-canvas-cad", je);
class Ke {
  constructor(i, e) {
    n(this, "polylines", []);
  ...
  plotSegmentos(i, e) {
    this.core.map && i.forEach((t) => {
      const o = e.find((r) => String(r.id) === String(t.ponto_inicio_id)), a = e.find((r) => String(r.id) === String(t.ponto_fim_id));
      if (o && a && o.lat && o.lon && a.lat && a.lon) {
        const r = t.tipo_limite_sigef || t.tipo_limite || "", s = t.metodo_posicionamento_sigef || t.metodo_posicionamento || "", l = this.bancoPontosAtivo ? "#94a3b8" : r === "LA1" ? "#10b981" : "#3b82f6", d = this.core.config.perimetroWeight, h = this.bancoPontosAtivo ? 0.4 : 1, c = v.polyline([[o.lat, o.lon], [a.lat, a.lon]], {
          color: l,
          weight: d,
          opacity: h,
          ...
          <div style="font-family:sans-serif; color:rgba(255, 255, 255, 0.9); line-height:1.3;">
            <div style="font-weight:700; font-size:12px; margin-bottom:3px; color:#ffffff;">${w(o.nome_vertice)} ↔ ${w(a.nome_vertice)}</div>
            <div style="font-size:11px; color:rgba(255, 255, 255, 0.65);">Limite: ${w(r)} · ${w(s)}</div>
          </div>
        `, {
          className: "compact-popup",
          maxWidth: 220
  ...
  plotPolilinhaTemporaria(i) {
    if (!this.core.map) return;
    const e = i.filter(
      (s) => s.lat && s.lon && s.lat !== 0 && s.lon !== 0 && s.tipo_ponto !== "B" && s.tipo !== "B" && s.ignorar_poligono !== 1
    );
    if (e.length < 2) return;
    const t = {};
    e.forEach((s) => {
      const l = s.matricula_id != null ? `mat_${s.matricula_id}` : s.planilha_origem || "default";
      t[l] || (t[l] = []), t[l].push(s);
    });
    const o = this.bancoPontosAtivo ? "#94a3b8" : "#10b981", a = this.core.config.fechamentoWeight || 2, r = this.bancoPontosAtivo ? 0.4 : 1;
    Object.values(t).forEach((s) => {
      if (s.sort((c, p) => Number(c.ordem_caminhamento ?? 999999) - Number(p.ordem_caminhamento ?? 999999)), s.length < 2) return;
      for (let c = 0; c < s.length - 1; c++) {
        const p = s[c], x = s[c + 1], f = v.polyline([[p.lat, p.lon], [x.lat, x.lon]], {
          color: o,
          weight: a,
          opacity: r,
          pane: "perimetroPane"
      ...
      const l = s[s.length - 1], d = s[0], h = v.polyline([[l.lat, l.lon], [d.lat, d.lon]], {
        color: o,
        weight: a,
        opacity: r,
        dashArray: "4, 4",
  ...
  plotPoligonalHomologada(i) {
    ...
    const e = i.filter((o) => o.lat && o.lon && o.lat !== 0 && o.lon !== 0);
    if (e.length === 0) return;
    this.bancoPontosAtivo = !0, e.forEach((o) => {
      const a = `
        <div class="w-4.5 h-4.5 bg-amber-500 text-slate-950 border-2 border-slate-900 rounded-full flex items-center justify-center text-[7px] font-black font-mono shadow-md hover:scale-125 transition-transform" id="banco-marker-${o.id}">
          H
        </div>
      `, r = v.divIcon({
        html: a,
        ...
        <div style="font-family:sans-serif; color:rgba(255, 255, 255, 0.9); line-height:1.35; min-width:180px;">
          ...
          <div style="font-weight:700; font-size:13px; margin-bottom:3px; color:#ffffff;">${w(o.codigo_completo || o.nome_vertice)}</div>
          <div style="font-size:11px; color:rgba(255, 255, 255, 0.7); font-family:monospace;">Este (E): ${o.este ? o.este.toFixed(2) : "N/A"} m</div>
          <div style="font-size:11px; color:rgba(255, 255, 255, 0.7); font-family:monospace; margin-bottom:3px;">Norte (N): ${o.norte ? o.norte.toFixed(2) : "N/A"} m</div>
          <div style="font-size:11px; color:rgba(255, 255, 255, 0.7); margin-bottom:2px;">Alt (h): <strong>${o.altitude ? o.altitude.toFixed(2) : "N/A"} m</strong></div>
          <div style="font-size:10px; color:rgba(255, 255, 255, 0.45);">Método: ${w(o.metodo_posicionamento) || "N/A"} · Limite: ${w(o.tipo_limite) || "N/A"}</div>
          ${o.confrontante_descritivo ? `<div style="font-size:10px; color:rgba(255, 255, 255, 0.65); border-top:1px solid rgba(255, 255, 255, 0.1); padding-top:4px; margin-top:4px; word-break:break-word;"><strong>Conf:</strong> ${w(o.confrontante_descritivo)}</div>` : ""}
        </div>
      `;
      v.marker([o.lat, o.lon], {
        icon: r,
        pane: "verticesPane"
      }).bindPopup(s, { className: "compact-popup", maxWidth: 220 }).addTo(this.core.bancoPontosGroup);
    });
    const t = {};
    e.forEach((o) => {
      const a = o.matricula_id ? `mat_${o.matricula_id}` : o.planilha_origem || "default";
      t[a] || (t[a] = []), t[a].push(o);
    });
    for (const o in t) {
      const a = t[o];
      if (a.sort((r, s) => {
        const l = r.ordem_caminhamento !== void 0 && r.ordem_caminhamento !== null ? r.ordem_caminhamento : r.id, d = s.ordem_caminhamento !== void 0 && s.ordem_caminhamento !== null ? s.ordem_caminhamento : s.id;
        return l - d;
      }), a.length >= 2) {
        const r = a.map((s) => v.latLng(s.lat, s.lon));
        r.push(v.latLng(a[0].lat, a[0].lon)), v.polyline(r, {
          color: "#f59e0b",
...
class Xe {
  constructor(i, e) {
    ...
    n(this, "core");
    n(this, "controller");
    this.core = i, this.controller = e;
  }
  plotPontos(i, e) {
    this.core.map && i.forEach((t) => {
      var o, a, r;
      if (t.lat && t.lon && t.lat !== 0 && t.lon !== 0) {
        const s = t.tipo_ponto === "B" || t.tipo === "B", l = t.tipo_ponto === "M" || t.tipo === "M";
        let d = "bg-mint-vibrant", h = "x", c = 7;
        l ? (d = "bg-indigo-500", c = 9) : s && (d = "bg-rose-500", c = 9);
        const p = this.core.config.enableAnimations ? "transition-all duration-150" : "", x = (a = (o = this.controller) == null ? void 0 : o.linhas) != null && a.bancoPontosAtivo ? "opacity-40 hover:opacity-100" : "", f = $(h, c, d, `${p} ${x}`, `map-marker-${t.id}`), m = v.divIcon({
          html: f,
          className: "custom-leaflet-marker flex items-center justify-center",
          iconSize: [c + 6, c + 6]
        }), u = l ? "Base Homologada PPP" : s ? "Base de Campo (Translação)" : "Vértice de Perímetro", b = v.marker([t.lat, t.lon], {
          icon: m,
          pane: "verticesPane"
        });
        b.pontoId = t.id, (r = this.controller) != null && r.modoCliqueSequencialAtivo || b.bindPopup(`
            <div style="font-family:sans-serif; color:rgba(255, 255, 255, 0.9); line-height:1.3;">
              <div style="font-weight:700; font-size:13px; margin-bottom:4px; color:#ffffff;">${w(t.nome_vertice)}</div>
              <div style="font-size:11px; color:rgba(255, 255, 255, 0.65);">${w(u)} · ${w(t.tipo_ponto || t.tipo)}</div>
          ...
          className: "compact-popup",
          maxWidth: 220
        }), b.addTo(this.core.map), b.setZIndexOffset(1e3), b.on("click", () => {
          e(t.id);
        }), this.markers.push(b);
      }
    });
  ...
  plotPontosVizinhos(i) {
    ...
    (i || []).forEach((t) => {
      const o = t.lat ?? t.latitude ?? t.y, a = t.lon ?? t.lng ?? t.longitude ?? t.x, r = typeof o == "string" ? parseFloat(o.replace(",", ".")) : Number(o), s = typeof a == "string" ? parseFloat(a.replace(",", ".")) : Number(a);
      ...
      if (t.length >= 2) {
        t.sort((a, r) => a.id - r.id);
        const o = t.map((a) => v.latLng(a.lat, a.lon));
        t.length > 2 && o.push(v.latLng(t[0].lat, t[0].lon)), v.polyline(o, {
          color: "#a855f7",
      ...
      t.forEach((o) => {
        const a = w(String(o.id)), r = `
          <div class="p-2 font-sans text-xs bg-[#0c1510] text-white min-w-[200px] rounded">
            ...
            <div class="mb-1"><strong>Vértice:</strong> <span class="font-mono">${w(o.nome_vertice || "")}</span></div>
            <div class="mb-1"><strong>Proprietário:</strong> ${w(o.nome_confrontante || "") || "Desconhecido"}</div>
            <div class="mb-1"><strong>Propriedade:</strong> ${w(o.nome_propriedade || "") || "Desconhecida"}</div>
            ...
            <div style="display:flex; gap:6px; border-top:1px solid rgba(255,255,255,0.1); padding-top:6px;">
              <button onclick="window.dispatchEvent(new CustomEvent('gerencigeo:integrar_vizinho', { detail: { pontoId: ${a} } }))" style="padding:3px 8px; font-size:10px; font-weight:700; border-radius:4px; background:#00f5a0; color:#04150c; border:none; cursor:pointer;" type="button">
                Integrar
              </button>
              <button onclick="window.dispatchEvent(new CustomEvent('gerencigeo:ocultar_vizinho', { detail: { pontoId: ${a} } }))" style="padding:3px 8px; font-size:10px; font-weight:700; border-radius:4px; background:rgba(255,255,255,0.1); color:rgba(255,255,255,0.8); border:1px solid rgba(255,255,255,0.15); cursor:pointer;" type="button">
                Ocultar
              </button>
            </div>
          </div>
        `;
        let s = this.core.config.markerStyleV || "cross", l = this.core.config.markerSizeV || 8;
        o.tipo_ponto === "M" || o.tipo === "M" || o.tipo === "B" ? (s = this.core.config.markerStyleM || "circle-dot", l = this.core.config.markerSizeM || 14) : (o.tipo_ponto === "P" || o.tipo === "P" || o.tipo === "O") && (s = this.core.config.markerStyleP || "circle", l = this.core.config.markerSizeP || 10);
        const d = this.core.config.enableAnimations ? "transition-all duration-150" : "", h = $(s, l, "bg-[#a855f7]", d, `map-marker-vizinho-${o.id}`), c = v.divIcon({
          html: h,
          className: "custom-leaflet-marker flex items-center justify-center",
          iconSize: [l + 4, l + 4]
        }), p = v.marker([o.lat, o.lon], {
          icon: c,
          pane: "overlayPane"
        }).bindPopup(r, { className: "custom-leaflet-popup" });
        p.pontoId = o.id, p.isVizinho = !0, p.addTo(this.core.pontosVizinhosGroup), this.vizinhosMarkers.push(p);
      });
    });
  }
  /**
  ...
  plotPoligonosVizinhos(i) {
    !this.core.map || !this.core.pontosVizinhosGroup || (this.core.map.hasLayer(this.core.pontosVizinhosGroup) || this.core.pontosVizinhosGroup.addTo(this.core.map), this.vizinhosPoligonos.length > 0 && (this.vizinhosPoligonos.forEach((e) => e.off()), this.vizinhosPoligonos = []), (i || []).forEach((e) => {
      if (!e || !e.poligono_wkt) return;
      const t = /POLYGON\s*\(\s*\(\s*(.*?)\s*\)\s*\)/i.exec(e.poligono_wkt);
      if (!t) return;
      const o = t[1].split(",").map((l) => {
        const d = l.trim().split(/\s+/), h = parseFloat(d[0]), c = parseFloat(d[1]);
        return !isNaN(c) && !isNaN(h) ? [c, h] : null;
      }).filter((l) => l !== null);
      if (o.length < 3) return;
      const a = w(e.nome_propriedade || "Propriedade Vizinha"), r = w(e.nome || "Desconhecido"), s = v.polygon(o, {
        color: "#a855f7",
        weight: this.core.config.vizinhoWeight,
        dashArray: "4, 6",
        fillColor: "#a855f7",
...
class We {
   ...
   */
  on(i, e) {
    return this.listeners.has(i) || this.listeners.set(i, /* @__PURE__ */ new Set()), this.listeners.get(i).add(e), () => this.off(i, e);
  }
  /**
  ...
  abrirModal(i) {
    ...
    return e && typeof e.abrir == "function" ? (e.abrir(), this.emit("modal:aberto", { id: i }), !0) : e ? (e.setAttribute("aberto", ""), this.emit("modal:aberto", { id: i }), !0) : (console.warn(`[UIBus] Modal com ID "${i}" não encontrado no DOM.`), !1);
  }
  /**
  ...
  fecharModal(i) {
    if (i) {
      const e = document.getElementById(i);
      return e && typeof e.fechar == "function" ? (e.fechar(), this.emit("modal:fechado", { id: i }), !0) : e ? (e.removeAttribute("aberto"), e.removeAttribute("open"), this.emit("modal:fechado", { id: i }), !0) : !1;
    } else
      return document.querySelectorAll("ui-modal[aberto], ui-modal[open], ui-dialog[aberto], ui-dialog[open]").forEach((t) => {
  ...
  async copiar(i, e) {
    try {
      return await navigator.clipboard.writeText(i), e !== void 0 && this.notificar({
        tipo: "sucesso",
  ...
  definirDensidade(i) {
    let e = 20;
    typeof i == "number" ? e = Math.max(15, i) : i === "compacta" ? e = 15 : i === "relaxada" ? e = 32 : e = 20, document.documentElement.style.setProperty("--ui-altura-minima", `${e}px`), document.documentElement.style.setProperty("--ui-campo-altura", `${e}px`), document.documentElement.setAttribute("data-ui-densidade", typeof i == "string" ? i : "custom"), this.emit("densidade:alterada", { densidade: i, alturaPx: e });
  }
  /**
   * Alterna ou define o tema visual global.
   */
  definirTema(i) {
    const e = document.documentElement, t = e.getAttribute("data-tema") || (e.classList.contains("dark") ? "escuro" : "claro"), o = i || (t === "escuro" ? "claro" : "escuro");
    return e.setAttribute("data-tema", o), o === "escuro" ? e.classList.add("dark") : e.classList.remove("dark"), this.emit("tema:alterado", { tema: o }), o;
  }
}
const M = new We();
let G = !1;
function Ge() {
  G || typeof document > "u" || (G = !0, document.addEventListener("click", (g) => {
    const i = g.target;
    if (!i) return;
    const e = i.closest(
    ...
    if (!e) return;
    const t = e.getAttribute("target-modal") || e.getAttribute("modal-alvo");
    if (t && M.abrirModal(t), e.hasAttribute("dismiss-modal") || e.hasAttribute("fechar-modal")) {
      const c = e.getAttribute("dismiss-modal") || e.getAttribute("fechar-modal");
      if (c && c !== "")
        M.fecharModal(c);
      else {
        const p = e.closest("ui-modal, ui-dialog");
        p && (typeof p.fechar == "function" ? p.fechar() : (p.removeAttribute("aberto"), p.removeAttribute("open")));
      }
    }
    const o = e.getAttribute("toast-sucesso");
    o && M.notificar({ tipo: "sucesso", mensagem: o });
    const a = e.getAttribute("toast-erro");
    a && M.notificar({ tipo: "erro", mensagem: a });
    const r = e.getAttribute("toast-alerta");
    r && M.notificar({ tipo: "alerta", mensagem: r });
    const s = e.getAttribute("toast-info");
    s && M.notificar({ tipo: "info", mensagem: s });
    const l = e.getAttribute("copiar-texto");
    if (l !== null) {
      let c = l;
      if (l.startsWith("#") || l.startsWith(".")) {
        const x = document.querySelector(l);
        x && (c = x.value !== void 0 ? x.value : x.textContent || "");
      }
      const p = e.getAttribute("copiar-mensagem") || "Copiado com sucesso!";
      M.copiar(c, p);
    }
    e.hasAttribute("alternar-tema") && M.definirTema();
    const d = e.getAttribute("definir-densidade");
    d && M.definirDensidade(d);
    const h = e.getAttribute("limpar-form");
    if (h) {
      const c = document.getElementById(h);
      c && typeof c.reset == "function" && (c.reset(), M.notificar({ tipo: "info", mensagem: "Formulário limpo." }));
    }
  }));
}
typeof document < "u" && Ge();
export {
  qe as CanvasInteracao,
  Ve as CanvasLayerManager,
  W as DEFAULT_CONFIG,
  Re as DEFAULT_LAYERS,
  De as GerenciGeoMapaController,
  Fe as GridLayerRenderer,
  S as LayerRendererFactory,
  B as ListenerBag,
  O as MapaConfigManager,
  Te as MapaCore,
  Ke as MapaLinhas,
  Xe as MapaMarcadores,
  Be as TileLayerRenderer,
  K as UIAlerta,
  xe as UIAvatar,
  V as UIBadge,
  U as UIBotao,
  ie as UIBotaoPrimario,
  M as UIBus,
  Y as UICampoTexto,
  je as UICanvasCAD,
  ye as UICard,
  ...
  we as UIDialog,
  ce as UIIcone,
  F as UIListaFlutuante,
  ze as UIMapa,
  Ie as UIMapaLinha,
  Me as UIMapaMarcador,
  N as UIModal,
  Ae as UIPopover,
  H as UIRadio,
  ae as UISelect,
  ...
  pe as UIToggle,
  X as UITooltip,
  $e as VectorLinesLayerRenderer,
  He as VectorPointsLayerRenderer,
  Oe as VectorPolygonsLayerRenderer,
  Ne as WmsLayerRenderer,
  w as escapeHtml,
  Ze as formatUTM,
  $ as getPointShapeHtml,
  Ge as initZeroJSTriggers
};
